...
const LEGAL = {
  ...
  <h2>4. Empfänger und Auftragsverarbeiter</h2><ul><li>${STRIPE} Payments Europe, Ltd. (Dublin) — Zahlungsabwicklung.</li><li><strong>Fulfillment-Partner</strong> in Lettland (EU) — Name und Lieferadresse.</li><li><strong>Hosting</strong> — GitHub Pages und ein Cloudflare Worker. Für Übermittlungen außerhalb des EWR gelten Standardvertragsklauseln.</li><li><strong>Statistik &amp; Werbung (mit Einwilligung):</strong> Google (Analytics 4, Ads), Meta Platforms, TikTok — siehe §5.</li></ul>
  <h2>5. Cookies, Statistik &amp; Werbung</h2><p>Wir verwenden essenziellen lokalen Speicher (Warenkorb und Sprache), der keine Einwilligung erfordert. <strong>Mit Ihrer Einwilligung</strong> verwenden wir außerdem <strong>Google Analytics 4</strong>, <strong>Google Ads</strong>, das <strong>Meta-(Facebook/Instagram-)Pixel</strong> und das <strong>TikTok-Pixel</strong>, um Besuche zu messen und relevante Werbung anzuzeigen. Diese Dienste werden erst geladen, nachdem Sie über unser Cookie-Banner zugestimmt haben (Google Consent Mode v2; standardmäßig abgelehnt). Dabei können Cookies gesetzt und Daten an Google, Meta und TikTok übermittelt werden, auch außerhalb des EWR unter geeigneten Garantien. Sie können Ihre Auswahl jederzeit über „Cookie-Einstellungen“ im Footer ändern oder widerrufen.</p>
  ...
  <h2>4. Ontvangers en verwerkers</h2><ul><li>${STRIPE} Payments Europe, Ltd. (Dublin) — betalingen.</li><li><strong>Fulfilmentpartner</strong> in Letland (EU) — naam en bezorgadres.</li><li><strong>Hosting</strong> — GitHub Pages en een Cloudflare Worker. Voor doorgifte buiten de EER gelden modelcontractbepalingen.</li><li><strong>Statistieken &amp; advertenties (met toestemming):</strong> Google (Analytics 4, Ads), Meta Platforms, TikTok — zie §5.</li></ul>
  <h2>5. Cookies, statistieken &amp; advertenties</h2><p>We gebruiken essentiële lokale opslag (winkelwagen en taal), waarvoor geen toestemming nodig is. <strong>Met jouw toestemming</strong> gebruiken we ook <strong>Google Analytics 4</strong>, <strong>Google Ads</strong>, de <strong>Meta-(Facebook/Instagram-)pixel</strong> en de <strong>TikTok-pixel</strong> om bezoeken te meten en relevante advertenties te tonen. Deze diensten worden pas geladen nadat je via onze cookiebanner akkoord bent gegaan (Google Consent Mode v2; standaard geweigerd). Hierbij kunnen cookies worden geplaatst en gegevens worden doorgegeven aan Google, Meta en TikTok, ook buiten de EER met passende waarborgen. Je kunt je keuze altijd wijzigen of intrekken via "Cookie-instellingen" in de footer.</p>
